 ...
 */
public class DoubleListAdapter extends java.util.AbstractList {
...
public void add(int index, Object element) {
	this.content.beforeInsert(index,value(element));
	this.modCount++;
}
/**
...
public Object get(int index) {
	return object(this.content.get(index));
}
/**
...
public Object set(int index, Object element) {
	Object old = get(index);
	this.content.set(index,value(element));
	return old;
}
/**
